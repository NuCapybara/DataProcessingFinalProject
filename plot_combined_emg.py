...
file_path = "/home/jialuyu/Data_Final_Project/DataProcessingFinalProject/emg_csv_data/emg_scale/h0/H_r2deg22h0_segmented/RL_emg_combined_formatted.csv"  # Replace with the actual file path
...
channel_data = [
    df[f"ch{i}"].values for i in range(1, 9)
